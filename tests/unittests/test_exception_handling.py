...
class TestExceptionHandling(unittest.TestCase):
    ...
    def test_401_error_in_response(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), f'HTTP-error-code: 401, Error: {json["error_description"]}')
    ...
    def test_402_error(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 402, Error: The requested operation requires more resources "
    ...
    def test_403_quota_exceeded_error(self, mocked_sleep, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), f'HTTP-error-code: 403, Error: {json["error"]["message"]}')
    ...
    def test_404_error_in_response(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), f'HTTP-error-code: 404, Error: {json["error"]["message"]}')
    ...
    def test_405_error(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e),
                              "HTTP-error-code: 405, Error: The HTTP method associated with the request is not "
                              "supported.")
    ...
    def test_412_error(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 412, Error: The condition set in the request's If-Match or "
    ...
    def test_428_error(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 428, Error: The request requires a precondition If-Match or "
...
class TestAccessToken(unittest.TestCase):
    ...
    def test_405_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 405, Error: The HTTP method associated with the request is "
                                      "not supported.")
    ...
    def test_409_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 409, Error: The API request cannot be completed because the "
    ...
    def test_416_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 416, Error: The request specified a range that cannot be "
                                      "satisfied.")
    ...
    def test_500_error(self, mocked_sleep, mocked_request):
        ...
        with self.assertRaises(exceptions.GoogleInternalServiceError) as err:
            with client.GoogleClient("", "", "", "") as _:
                self.assertEquals(str(err), "HTTP-error-code: 500, Error: The request failed due to an internal error.")
    ...
    def test_501_error(self, mocked_sleep, mocked_request):
        ...
        with self.assertRaises(exceptions.GoogleNotImplementedError) as err:
            with client.GoogleClient("", "", "", "") as _:
                self.assertEquals(str(err), "HTTP-error-code: 501, Error: Functionality does not exist.")
            # on 5xx error function backoff and retries 5 times
            self.assertEquals(mocked_request.call_count, 5)
    ...
    def test_503_error(self, mocked_sleep, mocked_request):
        ...
        with self.assertRaises(exceptions.GoogleServiceUnavailable) as err:
            google_client.get_access_token()
            self.assertEquals(str(err), "HTTP-error-code: 503, Error: The API service is currently unavailable.")
